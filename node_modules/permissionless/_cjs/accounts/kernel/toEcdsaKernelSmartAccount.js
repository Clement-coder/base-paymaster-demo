...
const isKernelV2_1 = require("./utils/isKernelV2.js");
...
const getInitializationData = ({ entryPoint: { version: entryPointVersion }, kernelVersion, owner, ecdsaValidatorAddress }) => {
    ...
    return (0, viem_1.encodeFunctionData)({
        abi: KernelV3AccountAbi_1.KernelV3_1AccountAbi,
        functionName: "initialize",
        args: [
            (0, exports.getEcdsaRootIdentifierForKernelV3)(ecdsaValidatorAddress),
            viem_1.zeroAddress,
...
async function toEcdsaKernelSmartAccount(parameters) {
    ...
    return (0, account_abstraction_1.toSmartAccount)({
        ...
        async encodeCalls(calls) {
            return (0, encodeCallData_1.encodeCallData)({ calls, kernelVersion });
        },
        async getNonce(_args) {
            return (0, getAccountNonce_1.getAccountNonce)(client, {
                address: await this.getAddress(),
                entryPointAddress: entryPoint.address,
                key: (0, getNonceKey_1.getNonceKeyWithEncoding)(kernelVersion, ecdsaValidatorAddress, parameters.nonceKey ?? 0n)
            });
        },
        async getStubSignature() {
            if ((0, isKernelV2_1.isKernelV2)(kernelVersion)) {
